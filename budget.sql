...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2021 at 06:41 PM
...
--
-- Table structure for table `budget_image`
--

CREATE TABLE `budget_image` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `budget_image`
--

INSERT INTO `budget_image` (`id`, `user_id`, `photo`, `date_id`) VALUES
(2, '1', '61366675b53e8bootsrap 3.3.7.PNG', '2021-09-06 19:05:25'),
(3, '1', '61366687a4e4abootsrap front page.PNG', '2021-09-06 19:05:43'),
(5, '1', '61366b6d7a194am_i.PNG', '2021-09-06 19:26:37'),
(6, '1', '61366c620fa69bootsrap.PNG', '2021-09-06 19:30:42');
...
--
-- Indexes for table `budget_image`
--
ALTER TABLE `budget_image`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `budget_image`
--
ALTER TABLE `budget_image`
